...
We will only cover these 2 windows in this class, but many others exist (such as trapezoid, Barlett, Blackman, etc.). Nowaways, it is common to run through multiple windowing functions to see which one works best for the given application.
