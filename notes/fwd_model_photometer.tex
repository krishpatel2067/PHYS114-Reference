...
\begin{itemize}
    ...
    \item The receiver can either be a \textbf{photomultiplier tube (PMT)} or a \textbf{single-photon avalanche diode (SPAD)}. A PMT is a single-element instrument that counts individual photos precisely.
