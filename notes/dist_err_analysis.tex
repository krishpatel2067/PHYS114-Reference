...
\begin{equation*}
    \chi^2 \equiv \sum_{j=1}^{n} \frac{(h(x_j) - NP(x_j))^2}{\sigma_j(h)^2} = \sum_{i=1}^{N} \frac{(x_i - \bar{x})^2}{\sigma_i^2}
\end{equation*}
...
\,
\begin{itemize}
    \item $\chi^2$ is a measure of the goodness of fit of a model to the data.
    \item A smaller $\chi^2$ indicates a better fit. Ideal value is 0, but in practice it is around $n$ because the numerator and denominator of the summation are around the same order of magnitude.
